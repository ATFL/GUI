...
def collect_data():
    ...
    sensing_delay_time = 10# Time after data recording begins for the sensor to be exposed
    sensing_retract_time = 110# Number of seconds until the sensor is recovered
    duration_of_signal = 2000 # The total number of seconds for the whole process
...
##    # This section of code is used for generating the output file name. The file name will contain date/time of test, as well as concentration values present during test
    filename = time.strftime("/home/pi/Documents/GUI/Seven_GUI/Ali_N_Tests/%a%d%b%Y%H%M%S.csv",time.localtime())
...
def update_Graph():
    ...
    iveGraph.plot(timeVector, x3, pen = (218,42,42), name = 'Sensor 3')
