...
def collect_data():
    ...
    sensing_delay_time = 20# Time after data recording begins for the sensor to be exposed
    sensing_retract_time = 180# Number of seconds until the sensor is recovered
    duration_of_signal = 600
