...
class live_Graph(pg.PlotWidget):
    def __init__(self,parent=None):
        ...
        self.setRange(xRange=(0,700),yRange=(0,5),disableAutoRange=False)
        self.addLegend()
...
def collect_data():
    ...
    sensing_delay_time = 60# Time after data recording begins for the sensor to be exposed
    sensing_retract_time = 670# Number of seconds until the sensor is recovered
    duration_of_signal = 1280
    # The total number of seconds for the whole process
...
##    # This section of code is used for generating the output file name. The file name will contain date/time of test, as well as concentration values present during test
    filename = time.strftime("/home/pi/Documents/GUI/Seven_GUI/7sensor/PeymanTests/%a%d%b%Y%H%M%S.csv",time.localtime())
