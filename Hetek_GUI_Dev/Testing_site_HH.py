...
#################### System Variables ####################
# Purging Variables
clean_chamber_purge_time = 5 # normally 30s
sensing_chamber_purge_time = 5 # normally 60s
# Filling Variables
chamber_fill_time = 5 # normally 45, fill the sensing chamber with the outlet valve open.
