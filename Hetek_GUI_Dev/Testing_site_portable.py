...
#################### System Variables ####################
# Purging Variables
clean_chamber_purge_time = 1#30 # normally 30s
sensing_chamber_purge_time = 1#30 # normally 30s
# Filling Variables
chamber_fill_time = 1#40 # normally 40, fill the sensing chamber with the outlet valve open.
...
sensing_delay_time = 1#10 # normall 10, time delay after beginning data acquisition till when the sensor is exposed to sample
